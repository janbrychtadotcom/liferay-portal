...
public class CommerceCheckoutTest {
	...
	protected CommerceAddress addCommerceAddress(
		...
		return CommerceAddressLocalServiceUtil.addCommerceAddress(
			...
			RandomTestUtil.randomString(), //stree1
			RandomTestUtil.randomString(), //street2
			RandomTestUtil.randomString(), //street3
			RandomTestUtil.randomString(), //city
			RandomTestUtil.randomString(), //zip
			0, //regionId
			country.getCountryId(), //countryId
			RandomTestUtil.randomString(), //phoneNumber
			addressType,
			_serviceContext);
	}
